// src/docs/contexts/pos/sale/get-e-invoice-for-sale.doc.ts
export const getEInvoiceForSaleDoc = {
  operation: {
    summary: 'Factura electrónica de una venta',
  },

  responses: {
    200: {
      status: 200,
      description: 'Factura electrónica asociada a la venta indicada.',
      schema: {
        type: 'object',
        properties: {
          invoice_id: {
