...
export const getPromoInfoDoc = {
  ...
  responses: {
    200: {
      status: 200,
      description: 'Información completa de la promoción incluyendo sus reglas.',
      schema: {
        type: 'object',
        properties: {
          ...
          promotion_description: { type: 'string', example: 'Por cada bebida comprada llevas otra gratis' },
