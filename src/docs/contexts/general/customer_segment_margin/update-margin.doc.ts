...
export const updateMarginDoc = {
  operation: { summary: 'Update a segment margin', description: 'Updates an existing customer segment margin configuration.' },
  responses: {
    200: { status: 200, description: 'Margin updated.', schema: { type: 'object', properties: { message: { type: 'string', example: 'Margin updated' } } } },
